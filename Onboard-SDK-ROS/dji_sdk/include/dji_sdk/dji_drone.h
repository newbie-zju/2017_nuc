...
private:
	...
	//wyz:
	ros::ServiceClient takeOffandLandTest_service;
...
public:
		...
		waypoint_navigation_action_client(nh, "dji_sdk/waypoint_navigation_action", true)
	{
		...
		//wyz:
		takeOffandLandTest_service = nh.serviceClient<dji_sdk::LocalPositionControl>("dji_sdk/takeOffandLand_control");
	...
	bool takeOffandLandTest(float x, float y, float z, float yaw)
	{
		dji_sdk::LocalPositionControl takeOffandLand;
		takeOffandLand.request.x = x;
		takeOffandLand.request.y = y;
		takeOffandLand.request.z = z;
		takeOffandLand.request.yaw = yaw;
		return takeOffandLandTest_service.call(takeOffandLand) && takeOffandLand.response.result;
	}
