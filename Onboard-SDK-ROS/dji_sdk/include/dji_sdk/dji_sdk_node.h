...
//Publishers:
    ...
    ros::Publisher flight_ctrl_data_publisher;
    ros::Publisher quater_ctrl_data_publisher;
	...
	data_received_from_remote_device_publisher = nh.advertise<dji_sdk::TransparentTransmissionData>("dji_sdk/data_received_from_remote_device",10);
        flight_ctrl_data_publisher = nh.advertise<geometry_msgs::Point32>("dji_sdk/flight_ctrl_data",10);
	quater_ctrl_data_publisher = nh.advertise<geometry_msgs::Point32>("dji_sdk/quater_ctrl__data",10);
...
//Services:
	...
	ros::ServiceServer takeOffandLandTest_service;
    ...
    //wyz:
	bool takeOffandLand_control_callback(dji_sdk::LocalPositionControl::Request& request, dji_sdk::LocalPositionControl::Response& response);
	...
	activation_service = nh.advertiseService("dji_sdk/activation", &DJISDKNode::activation_callback, this);
        ...
        //wyz:
		takeOffandLandTest_service = nh.advertiseService("dji_sdk/takeOffandLand_control",&DJISDKNode::takeOffandLand_control_callback, this);
